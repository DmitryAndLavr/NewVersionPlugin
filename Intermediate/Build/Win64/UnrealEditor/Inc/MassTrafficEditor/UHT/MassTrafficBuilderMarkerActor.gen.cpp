...
FClassRegistrationInfo Z_Registration_Info_UClass_AMassTrafficBuilderMarkerActor;
UClass* AMassTrafficBuilderMarkerActor::GetPrivateStaticClass()
{
	using TClass = AMassTrafficBuilderMarkerActor;
	if (!Z_Registration_Info_UClass_AMassTrafficBuilderMarkerActor.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficBuilderMarkerActor"),
			Z_Registration_Info_UClass_AMassTrafficBuilderMarkerActor.InnerSingleton,
			StaticRegisterNativesAMassTrafficBuilderMarkerActor,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AMassTrafficBuilderMarkerActor.InnerSingleton;
}
UClass* Z_Construct_UClass_AMassTrafficBuilderMarkerActor_NoRegister()
{
	return AMassTrafficBuilderMarkerActor::GetPrivateStaticClass();
}
...
// ********** Begin Class AMassTrafficBuilderMarkerActor constinit property declarations ***********
...
// ********** End Class AMassTrafficBuilderMarkerActor constinit property declarations *************
...
// ********** Begin Class AMassTrafficBuilderMarkerActor Property Definitions **********************
...
// ********** End Class AMassTrafficBuilderMarkerActor Property Definitions ************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, AMassTrafficBuilderMarkerActor);
AMassTrafficBuilderMarkerActor::~AMassTrafficBuilderMarkerActor() {}
// ********** End Class AMassTrafficBuilderMarkerActor *********************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderMarkerActor_h__Script_MassTrafficEditor_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMassTrafficBuilderMarkerActor, AMassTrafficBuilderMarkerActor::StaticClass, TEXT("AMassTrafficBuilderMarkerActor"), &Z_Registration_Info_UClass_AMassTrafficBuilderMarkerActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMassTrafficBuilderMarkerActor), 2202839915U) },
	};
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderMarkerActor_h__Script_MassTrafficEditor_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderMarkerActor_h__Script_MassTrafficEditor_638707585{
	TEXT("/Script/MassTrafficEditor"),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderMarkerActor_h__Script_MassTrafficEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderMarkerActor_h__Script_MassTrafficEditor_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
