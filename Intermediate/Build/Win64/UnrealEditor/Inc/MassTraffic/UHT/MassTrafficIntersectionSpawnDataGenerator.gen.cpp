...
FClassRegistrationInfo Z_Registration_Info_UClass_UMassTrafficIntersectionSpawnDataGenerator;
UClass* UMassTrafficIntersectionSpawnDataGenerator::GetPrivateStaticClass()
{
	using TClass = UMassTrafficIntersectionSpawnDataGenerator;
	if (!Z_Registration_Info_UClass_UMassTrafficIntersectionSpawnDataGenerator.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficIntersectionSpawnDataGenerator"),
			Z_Registration_Info_UClass_UMassTrafficIntersectionSpawnDataGenerator.InnerSingleton,
			StaticRegisterNativesUMassTrafficIntersectionSpawnDataGenerator,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMassTrafficIntersectionSpawnDataGenerator.InnerSingleton;
}
UClass* Z_Construct_UClass_UMassTrafficIntersectionSpawnDataGenerator_NoRegister()
{
	return UMassTrafficIntersectionSpawnDataGenerator::GetPrivateStaticClass();
}
...
// ********** Begin Class UMassTrafficIntersectionSpawnDataGenerator constinit property declarations 
...
// ********** End Class UMassTrafficIntersectionSpawnDataGenerator constinit property declarations *
...
// ********** Begin Class UMassTrafficIntersectionSpawnDataGenerator Property Definitions **********
...
// ********** End Class UMassTrafficIntersectionSpawnDataGenerator Property Definitions ************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMassTrafficIntersectionSpawnDataGenerator);
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersectionSpawnDataGenerator_h__Script_MassTraffic_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficIntersectionSpawnDataGenerator, UMassTrafficIntersectionSpawnDataGenerator::StaticClass, TEXT("UMassTrafficIntersectionSpawnDataGenerator"), &Z_Registration_Info_UClass_UMassTrafficIntersectionSpawnDataGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficIntersectionSpawnDataGenerator), 4008249005U) },
	};
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersectionSpawnDataGenerator_h__Script_MassTraffic_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersectionSpawnDataGenerator_h__Script_MassTraffic_2226937853{
	TEXT("/Script/MassTraffic"),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersectionSpawnDataGenerator_h__Script_MassTraffic_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersectionSpawnDataGenerator_h__Script_MassTraffic_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
