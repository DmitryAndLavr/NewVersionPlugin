...
FClassRegistrationInfo Z_Registration_Info_UClass_UMassTrafficValidationProcessor;
UClass* UMassTrafficValidationProcessor::GetPrivateStaticClass()
{
	using TClass = UMassTrafficValidationProcessor;
	if (!Z_Registration_Info_UClass_UMassTrafficValidationProcessor.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficValidationProcessor"),
			Z_Registration_Info_UClass_UMassTrafficValidationProcessor.InnerSingleton,
			StaticRegisterNativesUMassTrafficValidationProcessor,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMassTrafficValidationProcessor.InnerSingleton;
}
UClass* Z_Construct_UClass_UMassTrafficValidationProcessor_NoRegister()
{
	return UMassTrafficValidationProcessor::GetPrivateStaticClass();
}
...
// ********** Begin Class UMassTrafficValidationProcessor constinit property declarations **********
...
// ********** End Class UMassTrafficValidationProcessor constinit property declarations ************
...
// ********** Begin Class UMassTrafficValidationProcessor Property Definitions *********************
...
// ********** End Class UMassTrafficValidationProcessor Property Definitions ***********************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMassTrafficValidationProcessor);
UMassTrafficValidationProcessor::~UMassTrafficValidationProcessor() {}
// ********** End Class UMassTrafficValidationProcessor ********************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficValidationProcessor_h__Script_MassTraffic_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficValidationProcessor, UMassTrafficValidationProcessor::StaticClass, TEXT("UMassTrafficValidationProcessor"), &Z_Registration_Info_UClass_UMassTrafficValidationProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficValidationProcessor), 1494671774U) },
	};
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficValidationProcessor_h__Script_MassTraffic_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficValidationProcessor_h__Script_MassTraffic_3878912747{
	TEXT("/Script/MassTraffic"),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficValidationProcessor_h__Script_MassTraffic_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficValidationProcessor_h__Script_MassTraffic_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
