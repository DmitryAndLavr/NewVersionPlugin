...
// ********** Begin Function GetDamageState constinit property declarations ************************
	static const UECodeGen_Private::FBytePropertyParams NewProp_ReturnValue_Underlying;
	static const UECodeGen_Private::FEnumPropertyParams NewProp_ReturnValue;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function GetDamageState constinit property declarations **************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function GetDamageState Property Definitions ***********************************
...
// ********** End Function GetDamageState Property Definitions *************************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMassTrafficVehicleInterface_GetDamageState_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UMassTrafficVehicleInterface, nullptr, "GetDamageState", 	Z_Construct_UFunction_UMassTrafficVehicleInterface_GetDamageState_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UMassTrafficVehicleInterface_GetDamageState_Statics::PropPointers), 
sizeof(MassTrafficVehicleInterface_eventGetDamageState_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x5C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMassTrafficVehicleInterface_GetDamageState_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMassTrafficVehicleInterface_GetDamageState_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Function OnDriverRemoved constinit property declarations ***********************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function OnDriverRemoved constinit property declarations *************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function OnDriverRemoved Property Definitions **********************************
...
// ********** End Function OnDriverRemoved Property Definitions ************************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMassTrafficVehicleInterface_OnDriverRemoved_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UMassTrafficVehicleInterface, nullptr, "OnDriverRemoved", 	Z_Construct_UFunction_UMassTrafficVehicleInterface_OnDriverRemoved_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UMassTrafficVehicleInterface_OnDriverRemoved_Statics::PropPointers), 
sizeof(MassTrafficVehicleInterface_eventOnDriverRemoved_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0CC20C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMassTrafficVehicleInterface_OnDriverRemoved_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMassTrafficVehicleInterface_OnDriverRemoved_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Function RepairDamage constinit property declarations **************************
// ********** End Function RepairDamage constinit property declarations ****************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMassTrafficVehicleInterface_RepairDamage_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UMassTrafficVehicleInterface, nullptr, "RepairDamage", 	nullptr, 
	0, 
0,
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMassTrafficVehicleInterface_RepairDamage_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMassTrafficVehicleInterface_RepairDamage_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UMassTrafficVehicleInterface;
UClass* UMassTrafficVehicleInterface::GetPrivateStaticClass()
{
	using TClass = UMassTrafficVehicleInterface;
	if (!Z_Registration_Info_UClass_UMassTrafficVehicleInterface.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficVehicleInterface"),
			Z_Registration_Info_UClass_UMassTrafficVehicleInterface.InnerSingleton,
			StaticRegisterNativesUMassTrafficVehicleInterface,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMassTrafficVehicleInterface.InnerSingleton;
}
UClass* Z_Construct_UClass_UMassTrafficVehicleInterface_NoRegister()
{
	return UMassTrafficVehicleInterface::GetPrivateStaticClass();
}
...
// ********** Begin Interface UMassTrafficVehicleInterface constinit property declarations *********
// ********** End Interface UMassTrafficVehicleInterface constinit property declarations ***********
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("GetDamageState"), .Pointer = &IMassTrafficVehicleInterface::execGetDamageState },
		{ .NameUTF8 = UTF8TEXT("OnDriverRemoved"), .Pointer = &IMassTrafficVehicleInterface::execOnDriverRemoved },
		{ .NameUTF8 = UTF8TEXT("RepairDamage"), .Pointer = &IMassTrafficVehicleInterface::execRepairDamage },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UMassTrafficVehicleInterface_GetDamageState, "GetDamageState" }, // 1201337029
		{ &Z_Construct_UFunction_UMassTrafficVehicleInterface_OnDriverRemoved, "OnDriverRemoved" }, // 2974263959
		{ &Z_Construct_UFunction_UMassTrafficVehicleInterface_RepairDamage, "RepairDamage" }, // 210876224
	};
...
void UMassTrafficVehicleInterface::StaticRegisterNativesUMassTrafficVehicleInterface()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_UMassTrafficVehicleInterface_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMassTrafficVehicleInterface);
// ********** End Interface UMassTrafficVehicleInterface *******************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleInterface_h__Script_MassTraffic_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficVehicleInterface, UMassTrafficVehicleInterface::StaticClass, TEXT("UMassTrafficVehicleInterface"), &Z_Registration_Info_UClass_UMassTrafficVehicleInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficVehicleInterface), 2035271978U) },
	};
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleInterface_h__Script_MassTraffic_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleInterface_h__Script_MassTraffic_2654876543{
	TEXT("/Script/MassTraffic"),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleInterface_h__Script_MassTraffic_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleInterface_h__Script_MassTraffic_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
