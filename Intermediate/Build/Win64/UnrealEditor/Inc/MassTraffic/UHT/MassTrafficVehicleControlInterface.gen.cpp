...
// ********** Begin Function OnParkedVehicleSpawned constinit property declarations ****************
// ********** End Function OnParkedVehicleSpawned constinit property declarations ******************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMassTrafficVehicleControlInterface_OnParkedVehicleSpawned_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UMassTrafficVehicleControlInterface, nullptr, "OnParkedVehicleSpawned", 	nullptr, 
	0, 
0,
...
// ********** Begin Function OnTrafficVehicleSpawned constinit property declarations ***************
// ********** End Function OnTrafficVehicleSpawned constinit property declarations *****************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMassTrafficVehicleControlInterface_OnTrafficVehicleSpawned_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UMassTrafficVehicleControlInterface, nullptr, "OnTrafficVehicleSpawned", 	nullptr, 
	0, 
0,
...
void IMassTrafficVehicleControlInterface::Execute_SetVehicleInputs(UObject* O, const float Throttle, const float Brake, bool bHandBrake, const float Steering, bool bSetSteering)
{
	...
	if (Func)
	{
		Parms.Throttle=std::move(Throttle);
		Parms.Brake=std::move(Brake);
		Parms.bHandBrake=std::move(bHandBrake);
		Parms.Steering=std::move(Steering);
		Parms.bSetSteering=std::move(bSetSteering);
...
// ********** Begin Function SetVehicleInputs constinit property declarations **********************
...
// ********** End Function SetVehicleInputs constinit property declarations ************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function SetVehicleInputs Property Definitions *********************************
...
// ********** End Function SetVehicleInputs Property Definitions ***********************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMassTrafficVehicleControlInterface_SetVehicleInputs_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UMassTrafficVehicleControlInterface, nullptr, "SetVehicleInputs", 	Z_Construct_UFunction_UMassTrafficVehicleControlInterface_SetVehicleInputs_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UMassTrafficVehicleControlInterface_SetVehicleInputs_Statics::PropPointers), 
sizeof(MassTrafficVehicleControlInterface_eventSetVehicleInputs_Parms),
...
FClassRegistrationInfo Z_Registration_Info_UClass_UMassTrafficVehicleControlInterface;
UClass* UMassTrafficVehicleControlInterface::GetPrivateStaticClass()
{
	using TClass = UMassTrafficVehicleControlInterface;
	if (!Z_Registration_Info_UClass_UMassTrafficVehicleControlInterface.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficVehicleControlInterface"),
			Z_Registration_Info_UClass_UMassTrafficVehicleControlInterface.InnerSingleton,
			StaticRegisterNativesUMassTrafficVehicleControlInterface,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMassTrafficVehicleControlInterface.InnerSingleton;
}
UClass* Z_Construct_UClass_UMassTrafficVehicleControlInterface_NoRegister()
{
	return UMassTrafficVehicleControlInterface::GetPrivateStaticClass();
}
...
// ********** Begin Interface UMassTrafficVehicleControlInterface constinit property declarations **
// ********** End Interface UMassTrafficVehicleControlInterface constinit property declarations ****
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("OnParkedVehicleSpawned"), .Pointer = &IMassTrafficVehicleControlInterface::execOnParkedVehicleSpawned },
		{ .NameUTF8 = UTF8TEXT("OnTrafficVehicleSpawned"), .Pointer = &IMassTrafficVehicleControlInterface::execOnTrafficVehicleSpawned },
		{ .NameUTF8 = UTF8TEXT("SetVehicleInputs"), .Pointer = &IMassTrafficVehicleControlInterface::execSetVehicleInputs },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UMassTrafficVehicleControlInterface_OnParkedVehicleSpawned, "OnParkedVehicleSpawned" }, // 2551477692
		{ &Z_Construct_UFunction_UMassTrafficVehicleControlInterface_OnTrafficVehicleSpawned, "OnTrafficVehicleSpawned" }, // 341581901
		{ &Z_Construct_UFunction_UMassTrafficVehicleControlInterface_SetVehicleInputs, "SetVehicleInputs" }, // 2743112572
	};
...
void UMassTrafficVehicleControlInterface::StaticRegisterNativesUMassTrafficVehicleControlInterface()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_UMassTrafficVehicleControlInterface_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMassTrafficVehicleControlInterface);
// ********** End Interface UMassTrafficVehicleControlInterface ************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleControlInterface_h__Script_MassTraffic_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficVehicleControlInterface, UMassTrafficVehicleControlInterface::StaticClass, TEXT("UMassTrafficVehicleControlInterface"), &Z_Registration_Info_UClass_UMassTrafficVehicleControlInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficVehicleControlInterface), 679100810U) },
	};
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleControlInterface_h__Script_MassTraffic_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleControlInterface_h__Script_MassTraffic_4059666485{
	TEXT("/Script/MassTraffic"),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleControlInterface_h__Script_MassTraffic_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleControlInterface_h__Script_MassTraffic_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
