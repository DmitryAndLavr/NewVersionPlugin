...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficTrailerConstraintSettings); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficTrailerConstraintSettings); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FMassTrafficTrailerConstraintSettings constinit property declarations 
...
// ********** End ScriptStruct FMassTrafficTrailerConstraintSettings constinit property declarations 
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficTrailerConstraintSettings;
class UScriptStruct* FMassTrafficTrailerConstraintSettings::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficTrailerConstraintSettings.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficTrailerConstraintSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficTrailerConstraintSettings, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficTrailerConstraintSettings"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficTrailerConstraintSettings.OuterSingleton;
	}

// ********** Begin ScriptStruct FMassTrafficTrailerConstraintSettings Property Definitions ********
...
// ********** End ScriptStruct FMassTrafficTrailerConstraintSettings Property Definitions **********
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficTrailerConstraintSettings.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficTrailerConstraintSettings.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficTrailerConstraintSettings_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficTrailerConstraintSettings.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficTrailerSimulationParameters); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficTrailerSimulationParameters); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/MassTrafficTrailerSimulationTrait.h" },
	};
...
// ********** Begin ScriptStruct FMassTrafficTrailerSimulationParameters constinit property declarations 
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FMassTrafficTrailerSimulationParameters constinit property declarations 
	static void* NewStructOps()
	{
...
static_assert(std::is_polymorphic<FMassTrafficTrailerSimulationParameters>() == std::is_polymorphic<FMassConstSharedFragment>(), "USTRUCT FMassTrafficTrailerSimulationParameters cannot be polymorphic unless super FMassConstSharedFragment is polymorphic");
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficTrailerSimulationParameters;
class UScriptStruct* FMassTrafficTrailerSimulationParameters::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficTrailerSimulationParameters.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficTrailerSimulationParameters.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficTrailerSimulationParameters, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficTrailerSimulationParameters"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficTrailerSimulationParameters.OuterSingleton;
	}

// ********** Begin ScriptStruct FMassTrafficTrailerSimulationParameters Property Definitions ******
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMassTrafficTrailerSimulationParameters_Statics::NewProp_ConstraintSettings = { "ConstraintSettings", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassTrafficTrailerSimulationParameters, ConstraintSettings), Z_Construct_UScriptStruct_FMassTrafficTrailerConstraintSettings, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ConstraintSettings_MetaData), NewProp_ConstraintSettings_MetaData) }; // 243653581
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FMassTrafficTrailerSimulationParameters_Statics::NewProp_PhysicsVehicleTemplateActor = { "PhysicsVehicleTemplateActor", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassTrafficTrailerSimulationParameters, PhysicsVehicleTemplateActor), Z_Construct_UClass_UClass_NoRegister, Z_Construct_UClass_AWheeledVehiclePawn_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PhysicsVehicleTemplateActor_MetaData), NewProp_PhysicsVehicleTemplateActor_MetaData) };
...
// ********** End ScriptStruct FMassTrafficTrailerSimulationParameters Property Definitions ********
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficTrailerSimulationParameters.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficTrailerSimulationParameters.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficTrailerSimulationParameters_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficTrailerSimulationParameters.InnerSingleton);
}
// ********** End ScriptStruct FMassTrafficTrailerSimulationParameters *****************************

// ********** Begin Class UMassTrafficTrailerSimulationTrait ***************************************
FClassRegistrationInfo Z_Registration_Info_UClass_UMassTrafficTrailerSimulationTrait;
UClass* UMassTrafficTrailerSimulationTrait::GetPrivateStaticClass()
{
	using TClass = UMassTrafficTrailerSimulationTrait;
	if (!Z_Registration_Info_UClass_UMassTrafficTrailerSimulationTrait.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficTrailerSimulationTrait"),
			Z_Registration_Info_UClass_UMassTrafficTrailerSimulationTrait.InnerSingleton,
			StaticRegisterNativesUMassTrafficTrailerSimulationTrait,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMassTrafficTrailerSimulationTrait.InnerSingleton;
}
UClass* Z_Construct_UClass_UMassTrafficTrailerSimulationTrait_NoRegister()
{
	return UMassTrafficTrailerSimulationTrait::GetPrivateStaticClass();
}
...
// ********** Begin Class UMassTrafficTrailerSimulationTrait constinit property declarations *******
	static const UECodeGen_Private::FStructPropertyParams NewProp_Params;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UMassTrafficTrailerSimulationTrait constinit property declarations *********
...
// ********** Begin Class UMassTrafficTrailerSimulationTrait Property Definitions ******************
...
// ********** End Class UMassTrafficTrailerSimulationTrait Property Definitions ********************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMassTrafficTrailerSimulationTrait);
UMassTrafficTrailerSimulationTrait::~UMassTrafficTrailerSimulationTrait() {}
// ********** End Class UMassTrafficTrailerSimulationTrait *****************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTrailerSimulationTrait_h__Script_MassTraffic_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMassTrafficTrailerConstraintSettings::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficTrailerConstraintSettings_Statics::NewStructOps, TEXT("MassTrafficTrailerConstraintSettings"),&Z_Registration_Info_UScriptStruct_FMassTrafficTrailerConstraintSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficTrailerConstraintSettings), 243653581U) },
		{ FMassTrafficTrailerSimulationParameters::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficTrailerSimulationParameters_Statics::NewStructOps, TEXT("MassTrafficTrailerSimulationParameters"),&Z_Registration_Info_UScriptStruct_FMassTrafficTrailerSimulationParameters, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficTrailerSimulationParameters), 1699978259U) },
	};
...
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTrailerSimulationTrait_h__Script_MassTraffic_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTrailerSimulationTrait_h__Script_MassTraffic_4214720125{
	TEXT("/Script/MassTraffic"),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTrailerSimulationTrait_h__Script_MassTraffic_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTrailerSimulationTrait_h__Script_MassTraffic_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTrailerSimulationTrait_h__Script_MassTraffic_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTrailerSimulationTrait_h__Script_MassTraffic_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
