...
FClassRegistrationInfo Z_Registration_Info_UClass_UMassTrafficParkedVehicleVisualizationTrait;
UClass* UMassTrafficParkedVehicleVisualizationTrait::GetPrivateStaticClass()
{
	using TClass = UMassTrafficParkedVehicleVisualizationTrait;
	if (!Z_Registration_Info_UClass_UMassTrafficParkedVehicleVisualizationTrait.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficParkedVehicleVisualizationTrait"),
			Z_Registration_Info_UClass_UMassTrafficParkedVehicleVisualizationTrait.InnerSingleton,
			StaticRegisterNativesUMassTrafficParkedVehicleVisualizationTrait,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMassTrafficParkedVehicleVisualizationTrait.InnerSingleton;
}
UClass* Z_Construct_UClass_UMassTrafficParkedVehicleVisualizationTrait_NoRegister()
{
	return UMassTrafficParkedVehicleVisualizationTrait::GetPrivateStaticClass();
}
...
// ********** Begin Class UMassTrafficParkedVehicleVisualizationTrait constinit property declarations 
// ********** End Class UMassTrafficParkedVehicleVisualizationTrait constinit property declarations 
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMassTrafficParkedVehicleVisualizationTrait);
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficParkedVehicleVisualizationTrait_h__Script_MassTraffic_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficParkedVehicleVisualizationTrait, UMassTrafficParkedVehicleVisualizationTrait::StaticClass, TEXT("UMassTrafficParkedVehicleVisualizationTrait"), &Z_Registration_Info_UClass_UMassTrafficParkedVehicleVisualizationTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficParkedVehicleVisualizationTrait), 2960065602U) },
	};
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficParkedVehicleVisualizationTrait_h__Script_MassTraffic_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficParkedVehicleVisualizationTrait_h__Script_MassTraffic_1043461259{
	TEXT("/Script/MassTraffic"),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficParkedVehicleVisualizationTrait_h__Script_MassTraffic_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficParkedVehicleVisualizationTrait_h__Script_MassTraffic_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
