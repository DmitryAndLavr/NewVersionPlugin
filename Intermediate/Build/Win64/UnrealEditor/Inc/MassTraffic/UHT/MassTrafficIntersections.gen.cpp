...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficIntersectionSide); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficIntersectionSide); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FMassTrafficIntersectionSide constinit property declarations ******
...
// ********** End ScriptStruct FMassTrafficIntersectionSide constinit property declarations ********
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionSide;
class UScriptStruct* FMassTrafficIntersectionSide::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionSide.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionSide.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficIntersectionSide, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficIntersectionSide"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionSide.OuterSingleton;
	}

// ********** Begin ScriptStruct FMassTrafficIntersectionSide Property Definitions *****************
...
// ********** End ScriptStruct FMassTrafficIntersectionSide Property Definitions *******************
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionSide.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionSide.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficIntersectionSide_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionSide.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficIntersectionHiddenOutboundSideHints); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficIntersectionHiddenOutboundSideHints); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
...
// ********** Begin ScriptStruct FMassTrafficIntersectionHiddenOutboundSideHints constinit property declarations 
	...
	static const UECodeGen_Private::FSetPropertyParams NewProp_CrosswalkWaitingLanes;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FMassTrafficIntersectionHiddenOutboundSideHints constinit property declarations 
	static void* NewStructOps()
	{
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionHiddenOutboundSideHints;
class UScriptStruct* FMassTrafficIntersectionHiddenOutboundSideHints::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionHiddenOutboundSideHints.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionHiddenOutboundSideHints.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficIntersectionHiddenOutboundSideHints, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficIntersectionHiddenOutboundSideHints"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionHiddenOutboundSideHints.OuterSingleton;
	}

// ********** Begin ScriptStruct FMassTrafficIntersectionHiddenOutboundSideHints Property Definitions 
...
// ********** End ScriptStruct FMassTrafficIntersectionHiddenOutboundSideHints Property Definitions 
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionHiddenOutboundSideHints.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionHiddenOutboundSideHints.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficIntersectionHiddenOutboundSideHints_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionHiddenOutboundSideHints.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficIntersectionDetail); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficIntersectionDetail); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/MassTrafficIntersections.h" },
	};
...
// ********** Begin ScriptStruct FMassTrafficIntersectionDetail constinit property declarations ****
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FMassTrafficIntersectionDetail constinit property declarations ******
	static void* NewStructOps()
	{
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionDetail;
class UScriptStruct* FMassTrafficIntersectionDetail::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionDetail.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionDetail.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficIntersectionDetail, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficIntersectionDetail"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionDetail.OuterSingleton;
	}

// ********** Begin ScriptStruct FMassTrafficIntersectionDetail Property Definitions ***************
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMassTrafficIntersectionDetail_Statics::NewProp_Sides = { "Sides", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassTrafficIntersectionDetail, Sides), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Sides_MetaData), NewProp_Sides_MetaData) }; // 589260511
...
// ********** End ScriptStruct FMassTrafficIntersectionDetail Property Definitions *****************
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionDetail.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionDetail.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficIntersectionDetail_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionDetail.InnerSingleton);
}
// ********** End ScriptStruct FMassTrafficIntersectionDetail **************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersections_h__Script_MassTraffic_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMassTrafficIntersectionSide::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficIntersectionSide_Statics::NewStructOps, TEXT("MassTrafficIntersectionSide"),&Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionSide, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficIntersectionSide), 589260511U) },
		{ FMassTrafficIntersectionHiddenOutboundSideHints::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficIntersectionHiddenOutboundSideHints_Statics::NewStructOps, TEXT("MassTrafficIntersectionHiddenOutboundSideHints"),&Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionHiddenOutboundSideHints, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficIntersectionHiddenOutboundSideHints), 4232589700U) },
		{ FMassTrafficIntersectionDetail::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficIntersectionDetail_Statics::NewStructOps, TEXT("MassTrafficIntersectionDetail"),&Z_Registration_Info_UScriptStruct_FMassTrafficIntersectionDetail, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficIntersectionDetail), 1687486107U) },
	};
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersections_h__Script_MassTraffic_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersections_h__Script_MassTraffic_94464556{
	TEXT("/Script/MassTraffic"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersections_h__Script_MassTraffic_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersections_h__Script_MassTraffic_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
