...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficVehicleSpacing); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficVehicleSpacing); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FMassTrafficVehicleSpacing constinit property declarations ********
...
// ********** End ScriptStruct FMassTrafficVehicleSpacing constinit property declarations **********
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficVehicleSpacing;
class UScriptStruct* FMassTrafficVehicleSpacing::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficVehicleSpacing.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficVehicleSpacing.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficVehicleSpacing, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficVehicleSpacing"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficVehicleSpacing.OuterSingleton;
	}

// ********** Begin ScriptStruct FMassTrafficVehicleSpacing Property Definitions *******************
...
// ********** End ScriptStruct FMassTrafficVehicleSpacing Property Definitions *********************
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficVehicleSpacing.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficVehicleSpacing.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficVehicleSpacing_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficVehicleSpacing.InnerSingleton);
}
// ********** End ScriptStruct FMassTrafficVehicleSpacing ******************************************

// ********** Begin Class UMassTrafficVehicleSpawnDataGenerator ************************************
FClassRegistrationInfo Z_Registration_Info_UClass_UMassTrafficVehicleSpawnDataGenerator;
UClass* UMassTrafficVehicleSpawnDataGenerator::GetPrivateStaticClass()
{
	using TClass = UMassTrafficVehicleSpawnDataGenerator;
	if (!Z_Registration_Info_UClass_UMassTrafficVehicleSpawnDataGenerator.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficVehicleSpawnDataGenerator"),
			Z_Registration_Info_UClass_UMassTrafficVehicleSpawnDataGenerator.InnerSingleton,
			StaticRegisterNativesUMassTrafficVehicleSpawnDataGenerator,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMassTrafficVehicleSpawnDataGenerator.InnerSingleton;
}
UClass* Z_Construct_UClass_UMassTrafficVehicleSpawnDataGenerator_NoRegister()
{
	return UMassTrafficVehicleSpawnDataGenerator::GetPrivateStaticClass();
}
...
// ********** Begin Class UMassTrafficVehicleSpawnDataGenerator constinit property declarations ****
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UMassTrafficVehicleSpawnDataGenerator constinit property declarations ******
...
// ********** End Class UMassTrafficVehicleSpawnDataGenerator Property Definitions *****************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMassTrafficVehicleSpawnDataGenerator);
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleSpawnDataGenerator_h__Script_MassTraffic_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMassTrafficVehicleSpacing::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficVehicleSpacing_Statics::NewStructOps, TEXT("MassTrafficVehicleSpacing"),&Z_Registration_Info_UScriptStruct_FMassTrafficVehicleSpacing, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficVehicleSpacing), 2881098583U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficVehicleSpawnDataGenerator, UMassTrafficVehicleSpawnDataGenerator::StaticClass, TEXT("UMassTrafficVehicleSpawnDataGenerator"), &Z_Registration_Info_UClass_UMassTrafficVehicleSpawnDataGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficVehicleSpawnDataGenerator), 2659450714U) },
	};
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleSpawnDataGenerator_h__Script_MassTraffic_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleSpawnDataGenerator_h__Script_MassTraffic_2535709403{
	TEXT("/Script/MassTraffic"),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleSpawnDataGenerator_h__Script_MassTraffic_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleSpawnDataGenerator_h__Script_MassTraffic_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleSpawnDataGenerator_h__Script_MassTraffic_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleSpawnDataGenerator_h__Script_MassTraffic_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
