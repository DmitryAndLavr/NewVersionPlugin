...
FClassRegistrationInfo Z_Registration_Info_UClass_UMassTrafficTrailerVisualizationTrait;
UClass* UMassTrafficTrailerVisualizationTrait::GetPrivateStaticClass()
{
	using TClass = UMassTrafficTrailerVisualizationTrait;
	if (!Z_Registration_Info_UClass_UMassTrafficTrailerVisualizationTrait.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficTrailerVisualizationTrait"),
			Z_Registration_Info_UClass_UMassTrafficTrailerVisualizationTrait.InnerSingleton,
			StaticRegisterNativesUMassTrafficTrailerVisualizationTrait,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMassTrafficTrailerVisualizationTrait.InnerSingleton;
}
UClass* Z_Construct_UClass_UMassTrafficTrailerVisualizationTrait_NoRegister()
{
	return UMassTrafficTrailerVisualizationTrait::GetPrivateStaticClass();
}
...
// ********** Begin Class UMassTrafficTrailerVisualizationTrait constinit property declarations ****
// ********** End Class UMassTrafficTrailerVisualizationTrait constinit property declarations ******
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMassTrafficTrailerVisualizationTrait);
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTrailerVisualizationTrait_h__Script_MassTraffic_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficTrailerVisualizationTrait, UMassTrafficTrailerVisualizationTrait::StaticClass, TEXT("UMassTrafficTrailerVisualizationTrait"), &Z_Registration_Info_UClass_UMassTrafficTrailerVisualizationTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficTrailerVisualizationTrait), 1672025848U) },
	};
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTrailerVisualizationTrait_h__Script_MassTraffic_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTrailerVisualizationTrait_h__Script_MassTraffic_2309989745{
	TEXT("/Script/MassTraffic"),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTrailerVisualizationTrait_h__Script_MassTraffic_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTrailerVisualizationTrait_h__Script_MassTraffic_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
