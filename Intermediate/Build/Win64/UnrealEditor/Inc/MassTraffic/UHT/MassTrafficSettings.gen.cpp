...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficLaneSpeedLimit); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficLaneSpeedLimit); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FMassTrafficLaneSpeedLimit constinit property declarations ********
...
// ********** End ScriptStruct FMassTrafficLaneSpeedLimit constinit property declarations **********
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficLaneSpeedLimit;
class UScriptStruct* FMassTrafficLaneSpeedLimit::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficLaneSpeedLimit.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficLaneSpeedLimit.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficLaneSpeedLimit, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficLaneSpeedLimit"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficLaneSpeedLimit.OuterSingleton;
	}

// ********** Begin ScriptStruct FMassTrafficLaneSpeedLimit Property Definitions *******************
...
// ********** End ScriptStruct FMassTrafficLaneSpeedLimit Property Definitions *********************
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficLaneSpeedLimit.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficLaneSpeedLimit.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficLaneSpeedLimit_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficLaneSpeedLimit.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficLaneDensity); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficLaneDensity); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/MassTrafficSettings.h" },
	};
...
// ********** Begin ScriptStruct FMassTrafficLaneDensity constinit property declarations ***********
	static const UECodeGen_Private::FStructPropertyParams NewProp_LaneFilter;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_DensityMultiplier;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FMassTrafficLaneDensity constinit property declarations *************
	static void* NewStructOps()
	{
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficLaneDensity;
class UScriptStruct* FMassTrafficLaneDensity::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficLaneDensity.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficLaneDensity.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficLaneDensity, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficLaneDensity"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficLaneDensity.OuterSingleton;
	}

// ********** Begin ScriptStruct FMassTrafficLaneDensity Property Definitions **********************
...
// ********** End ScriptStruct FMassTrafficLaneDensity Property Definitions ************************
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficLaneDensity.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficLaneDensity.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficLaneDensity_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficLaneDensity.InnerSingleton);
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UMassTrafficSettings;
UClass* UMassTrafficSettings::GetPrivateStaticClass()
{
	using TClass = UMassTrafficSettings;
	if (!Z_Registration_Info_UClass_UMassTrafficSettings.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficSettings"),
			Z_Registration_Info_UClass_UMassTrafficSettings.InnerSingleton,
			StaticRegisterNativesUMassTrafficSettings,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMassTrafficSettings.InnerSingleton;
}
UClass* Z_Construct_UClass_UMassTrafficSettings_NoRegister()
{
	return UMassTrafficSettings::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UMassTrafficSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_NextVehicleAvoidanceBrakingPower_MetaData[] = {
		{ "Category", "Speed|Stopping" },
		{ "ModuleRelativePath", "Public/MassTrafficSettings.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_StopSignBrakingPower_MetaData[] = {
		{ "Category", "Speed|Stopping" },
		{ "ModuleRelativePath", "Public/MassTrafficSettings.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ObstacleAvoidanceBrakingPower_MetaData[] = {
		{ "Category", "Obstacle Avoidance" },
		{ "ModuleRelativePath", "Public/MassTrafficSettings.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AlwaysUpdateIntersections_MetaData[] = {
		{ "Category", "Intersections" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Update intersections anyway even if there are no AI vehicles */" },
#endif
		{ "ModuleRelativePath", "Public/MassTrafficSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Update intersections anyway even if there are no AI vehicles" },
#endif
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_LaneChangeNextLaneRandom_MetaData[] = {
		{ "Category", "Lane Changing" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Should we randomly select a next lane\n" },
#endif
		{ "ModuleRelativePath", "Public/MassTrafficSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Should we randomly select a next lane" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RescueLaneMaxEvasion_MetaData[] = {
		{ "Category", "Rescue Lane" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Evading distance when EM vehicle approaches */" },
#endif
		{ "ModuleRelativePath", "Public/MassTrafficSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Evading distance when EM vehicle approaches" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RescueLaneNoiseScale_MetaData[] = {
		{ "Category", "Rescue Lane" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** How much variation in evasion */" },
#endif
		{ "ModuleRelativePath", "Public/MassTrafficSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "How much variation in evasion" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RescueLaneMaxSpeedMph_MetaData[] = {
		{ "Category", "Rescue Lane" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** max speed when forming rescue lane */" },
#endif
		{ "ModuleRelativePath", "Public/MassTrafficSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "max speed when forming rescue lane" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RescueLaneEMSpeedMultiplier_MetaData[] = {
		{ "Category", "Rescue Lane" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** max speed for EM vehicles when in emergency mode */" },
#endif
		{ "ModuleRelativePath", "Public/MassTrafficSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "max speed for EM vehicles when in emergency mode" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RescueLaneDistanceToIntersectionForPriority_MetaData[] = {
		{ "Category", "Rescue Lane" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** max speed for EM vehicles when in emergency mode */" },
#endif
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RescueLaneEMRecognitionDistance_MetaData[] = {
		{ "Category", "Rescue Lane" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** distance to which entities react to EM vehicles */" },
#endif
		{ "ModuleRelativePath", "Public/MassTrafficSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "distance to which entities react to EM vehicles" },
#endif
	};
...
// ********** Begin Class UMassTrafficSettings constinit property declarations *********************
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_NextVehicleAvoidanceBrakingPower;
	static const UECodeGen_Private::FStructPropertyParams NewProp_StoppingDistanceRange;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_StopSignBrakingPower;
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_ObstacleAvoidanceBrakingPower;
	static void NewProp_AlwaysUpdateIntersections_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_AlwaysUpdateIntersections;
	...
	static const UECodeGen_Private::FIntPropertyParams NewProp_LaneChangeNextLaneRandom;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_RescueLaneMaxEvasion;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_RescueLaneNoiseScale;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_RescueLaneMaxSpeedMph;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_RescueLaneEMSpeedMultiplier;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_RescueLaneDistanceToIntersectionForPriority;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_RescueLaneEMRecognitionDistance;
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UMassTrafficSettings constinit property declarations ***********************
...
// ********** Begin Class UMassTrafficSettings Property Definitions ********************************
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_TrafficLaneFilter = { "TrafficLaneFilter", nullptr, (EPropertyFlags)0x0010000000014001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassTrafficSettings, TrafficLaneFilter), Z_Construct_UScriptStruct_FZoneGraphTagFilter, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TrafficLaneFilter_MetaData), NewProp_TrafficLaneFilter_MetaData) }; // 2834384972
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_NextVehicleAvoidanceBrakingPower = { "NextVehicleAvoidanceBrakingPower", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassTrafficSettings, NextVehicleAvoidanceBrakingPower), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NextVehicleAvoidanceBrakingPower_MetaData), NewProp_NextVehicleAvoidanceBrakingPower_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_StopSignBrakingPower = { "StopSignBrakingPower", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassTrafficSettings, StopSignBrakingPower), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_StopSignBrakingPower_MetaData), NewProp_StopSignBrakingPower_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_ObstacleAvoidanceBrakingPower = { "ObstacleAvoidanceBrakingPower", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassTrafficSettings, ObstacleAvoidanceBrakingPower), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ObstacleAvoidanceBrakingPower_MetaData), NewProp_ObstacleAvoidanceBrakingPower_MetaData) };
void Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_AlwaysUpdateIntersections_SetBit(void* Obj)
{
	((UMassTrafficSettings*)Obj)->AlwaysUpdateIntersections = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_AlwaysUpdateIntersections = { "AlwaysUpdateIntersections", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMassTrafficSettings), &Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_AlwaysUpdateIntersections_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AlwaysUpdateIntersections_MetaData), NewProp_AlwaysUpdateIntersections_MetaData) };
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_LaneChangeNextLaneRandom = { "LaneChangeNextLaneRandom", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassTrafficSettings, LaneChangeNextLaneRandom), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LaneChangeNextLaneRandom_MetaData), NewProp_LaneChangeNextLaneRandom_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_RescueLaneMaxEvasion = { "RescueLaneMaxEvasion", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassTrafficSettings, RescueLaneMaxEvasion), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RescueLaneMaxEvasion_MetaData), NewProp_RescueLaneMaxEvasion_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_RescueLaneNoiseScale = { "RescueLaneNoiseScale", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassTrafficSettings, RescueLaneNoiseScale), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RescueLaneNoiseScale_MetaData), NewProp_RescueLaneNoiseScale_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_RescueLaneMaxSpeedMph = { "RescueLaneMaxSpeedMph", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassTrafficSettings, RescueLaneMaxSpeedMph), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RescueLaneMaxSpeedMph_MetaData), NewProp_RescueLaneMaxSpeedMph_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_RescueLaneEMSpeedMultiplier = { "RescueLaneEMSpeedMultiplier", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassTrafficSettings, RescueLaneEMSpeedMultiplier), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RescueLaneEMSpeedMultiplier_MetaData), NewProp_RescueLaneEMSpeedMultiplier_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_RescueLaneDistanceToIntersectionForPriority = { "RescueLaneDistanceToIntersectionForPriority", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassTrafficSettings, RescueLaneDistanceToIntersectionForPriority), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RescueLaneDistanceToIntersectionForPriority_MetaData), NewProp_RescueLaneDistanceToIntersectionForPriority_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_RescueLaneEMRecognitionDistance = { "RescueLaneEMRecognitionDistance", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassTrafficSettings, RescueLaneEMRecognitionDistance), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RescueLaneEMRecognitionDistance_MetaData), NewProp_RescueLaneEMRecognitionDistance_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_LaneDensities_Inner = { "LaneDensities", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FMassTrafficLaneDensity, METADATA_PARAMS(0, nullptr) }; // 1161002995
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_LaneDensities = { "LaneDensities", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassTrafficSettings, LaneDensities), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LaneDensities_MetaData), NewProp_LaneDensities_MetaData) }; // 1161002995
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMassTrafficSettings_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_NextVehicleAvoidanceBrakingPower,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_StopSignBrakingPower,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_ObstacleAvoidanceBrakingPower,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_AlwaysUpdateIntersections,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_LaneChangeNextLaneRandom,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_RescueLaneMaxEvasion,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_RescueLaneNoiseScale,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_RescueLaneMaxSpeedMph,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_RescueLaneEMSpeedMultiplier,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_RescueLaneDistanceToIntersectionForPriority,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMassTrafficSettings_Statics::NewProp_RescueLaneEMRecognitionDistance,
...
// ********** End Class UMassTrafficSettings Property Definitions **********************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMassTrafficSettings);
UMassTrafficSettings::~UMassTrafficSettings() {}
// ********** End Class UMassTrafficSettings *******************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficSettings_h__Script_MassTraffic_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EMassTrafficLaneChangeMode_StaticEnum, TEXT("EMassTrafficLaneChangeMode"), &Z_Registration_Info_UEnum_EMassTrafficLaneChangeMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 705246276U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMassTrafficLaneSpeedLimit::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficLaneSpeedLimit_Statics::NewStructOps, TEXT("MassTrafficLaneSpeedLimit"),&Z_Registration_Info_UScriptStruct_FMassTrafficLaneSpeedLimit, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficLaneSpeedLimit), 340088360U) },
		{ FMassTrafficLaneDensity::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficLaneDensity_Statics::NewStructOps, TEXT("MassTrafficLaneDensity"),&Z_Registration_Info_UScriptStruct_FMassTrafficLaneDensity, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficLaneDensity), 1161002995U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficSettings, UMassTrafficSettings::StaticClass, TEXT("UMassTrafficSettings"), &Z_Registration_Info_UClass_UMassTrafficSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficSettings), 4202336602U) },
	};
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficSettings_h__Script_MassTraffic_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficSettings_h__Script_MassTraffic_1829021101{
	TEXT("/Script/MassTraffic"),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficSettings_h__Script_MassTraffic_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficSettings_h__Script_MassTraffic_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficSettings_h__Script_MassTraffic_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficSettings_h__Script_MassTraffic_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficSettings_h__Script_MassTraffic_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficSettings_h__Script_MassTraffic_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
