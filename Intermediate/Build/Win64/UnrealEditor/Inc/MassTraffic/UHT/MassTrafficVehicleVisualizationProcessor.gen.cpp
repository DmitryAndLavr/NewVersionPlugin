...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficVehicleInstanceCustomData); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficVehicleInstanceCustomData); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FMassTrafficVehicleInstanceCustomData constinit property declarations 
...
// ********** End ScriptStruct FMassTrafficVehicleInstanceCustomData constinit property declarations 
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficVehicleInstanceCustomData;
class UScriptStruct* FMassTrafficVehicleInstanceCustomData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficVehicleInstanceCustomData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficVehicleInstanceCustomData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficVehicleInstanceCustomData, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficVehicleInstanceCustomData"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficVehicleInstanceCustomData.OuterSingleton;
	}

// ********** Begin ScriptStruct FMassTrafficVehicleInstanceCustomData Property Definitions ********
...
// ********** End ScriptStruct FMassTrafficVehicleInstanceCustomData Property Definitions **********
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficVehicleInstanceCustomData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficVehicleInstanceCustomData.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficVehicleInstanceCustomData_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficVehicleInstanceCustomData.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficPackedVehicleInstanceCustomData); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficPackedVehicleInstanceCustomData); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
...
// ********** Begin ScriptStruct FMassTrafficPackedVehicleInstanceCustomData constinit property declarations 
	static const UECodeGen_Private::FFloatPropertyParams NewProp_PackedParam1;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FMassTrafficPackedVehicleInstanceCustomData constinit property declarations 
	static void* NewStructOps()
	{
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficPackedVehicleInstanceCustomData;
class UScriptStruct* FMassTrafficPackedVehicleInstanceCustomData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficPackedVehicleInstanceCustomData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficPackedVehicleInstanceCustomData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficPackedVehicleInstanceCustomData, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficPackedVehicleInstanceCustomData"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficPackedVehicleInstanceCustomData.OuterSingleton;
	}

// ********** Begin ScriptStruct FMassTrafficPackedVehicleInstanceCustomData Property Definitions **
...
// ********** End ScriptStruct FMassTrafficPackedVehicleInstanceCustomData Property Definitions ****
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficPackedVehicleInstanceCustomData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficPackedVehicleInstanceCustomData.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficPackedVehicleInstanceCustomData_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficPackedVehicleInstanceCustomData.InnerSingleton);
}
// ********** End ScriptStruct FMassTrafficPackedVehicleInstanceCustomData *************************

// ********** Begin Class UMassTrafficVehicleVisualizationProcessor ********************************
FClassRegistrationInfo Z_Registration_Info_UClass_UMassTrafficVehicleVisualizationProcessor;
UClass* UMassTrafficVehicleVisualizationProcessor::GetPrivateStaticClass()
{
	using TClass = UMassTrafficVehicleVisualizationProcessor;
	if (!Z_Registration_Info_UClass_UMassTrafficVehicleVisualizationProcessor.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficVehicleVisualizationProcessor"),
			Z_Registration_Info_UClass_UMassTrafficVehicleVisualizationProcessor.InnerSingleton,
			StaticRegisterNativesUMassTrafficVehicleVisualizationProcessor,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMassTrafficVehicleVisualizationProcessor.InnerSingleton;
}
UClass* Z_Construct_UClass_UMassTrafficVehicleVisualizationProcessor_NoRegister()
{
	return UMassTrafficVehicleVisualizationProcessor::GetPrivateStaticClass();
}
...
// ********** Begin Class UMassTrafficVehicleVisualizationProcessor constinit property declarations 
// ********** End Class UMassTrafficVehicleVisualizationProcessor constinit property declarations **
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMassTrafficVehicleVisualizationProcessor);
...
FClassRegistrationInfo Z_Registration_Info_UClass_UMassTrafficVehicleUpdateCustomVisualizationProcessor;
UClass* UMassTrafficVehicleUpdateCustomVisualizationProcessor::GetPrivateStaticClass()
{
	using TClass = UMassTrafficVehicleUpdateCustomVisualizationProcessor;
	if (!Z_Registration_Info_UClass_UMassTrafficVehicleUpdateCustomVisualizationProcessor.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficVehicleUpdateCustomVisualizationProcessor"),
			Z_Registration_Info_UClass_UMassTrafficVehicleUpdateCustomVisualizationProcessor.InnerSingleton,
			StaticRegisterNativesUMassTrafficVehicleUpdateCustomVisualizationProcessor,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UMassTrafficVehicleUpdateCustomVisualizationProcessor.InnerSingleton;
}
UClass* Z_Construct_UClass_UMassTrafficVehicleUpdateCustomVisualizationProcessor_NoRegister()
{
	return UMassTrafficVehicleUpdateCustomVisualizationProcessor::GetPrivateStaticClass();
}
...
// ********** Begin Class UMassTrafficVehicleUpdateCustomVisualizationProcessor constinit property declarations 
// ********** End Class UMassTrafficVehicleUpdateCustomVisualizationProcessor constinit property declarations 
	static UObject* (*const DependentSingletons[])();
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMassTrafficVehicleUpdateCustomVisualizationProcessor);
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleVisualizationProcessor_h__Script_MassTraffic_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMassTrafficVehicleInstanceCustomData::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficVehicleInstanceCustomData_Statics::NewStructOps, TEXT("MassTrafficVehicleInstanceCustomData"),&Z_Registration_Info_UScriptStruct_FMassTrafficVehicleInstanceCustomData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficVehicleInstanceCustomData), 2380608891U) },
		{ FMassTrafficPackedVehicleInstanceCustomData::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficPackedVehicleInstanceCustomData_Statics::NewStructOps, TEXT("MassTrafficPackedVehicleInstanceCustomData"),&Z_Registration_Info_UScriptStruct_FMassTrafficPackedVehicleInstanceCustomData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficPackedVehicleInstanceCustomData), 1282973260U) },
	};
...
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleVisualizationProcessor_h__Script_MassTraffic_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleVisualizationProcessor_h__Script_MassTraffic_3718006499{
	TEXT("/Script/MassTraffic"),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleVisualizationProcessor_h__Script_MassTraffic_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleVisualizationProcessor_h__Script_MassTraffic_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleVisualizationProcessor_h__Script_MassTraffic_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleVisualizationProcessor_h__Script_MassTraffic_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
