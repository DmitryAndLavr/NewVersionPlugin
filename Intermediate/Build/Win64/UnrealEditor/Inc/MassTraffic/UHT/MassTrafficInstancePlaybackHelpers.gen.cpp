...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficAnimState); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficAnimState); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FMassTrafficAnimState constinit property declarations *************
...
// ********** End ScriptStruct FMassTrafficAnimState constinit property declarations ***************
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficAnimState;
class UScriptStruct* FMassTrafficAnimState::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficAnimState.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficAnimState.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficAnimState, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficAnimState"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficAnimState.OuterSingleton;
	}

// ********** Begin ScriptStruct FMassTrafficAnimState Property Definitions ************************
...
// ********** End ScriptStruct FMassTrafficAnimState Property Definitions **************************
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficAnimState.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficAnimState.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficAnimState_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficAnimState.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficInstancePlaybackData); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficInstancePlaybackData); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/MassTrafficInstancePlaybackHelpers.h" },
...
// ********** Begin ScriptStruct FMassTrafficInstancePlaybackData constinit property declarations **
	static const UECodeGen_Private::FStructPropertyParams NewProp_CurrentState;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FMassTrafficInstancePlaybackData constinit property declarations ****
	static void* NewStructOps()
	{
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficInstancePlaybackData;
class UScriptStruct* FMassTrafficInstancePlaybackData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficInstancePlaybackData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficInstancePlaybackData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficInstancePlaybackData, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficInstancePlaybackData"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficInstancePlaybackData.OuterSingleton;
	}

// ********** Begin ScriptStruct FMassTrafficInstancePlaybackData Property Definitions *************
...
// ********** End ScriptStruct FMassTrafficInstancePlaybackData Property Definitions ***************
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficInstancePlaybackData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficInstancePlaybackData.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficInstancePlaybackData_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficInstancePlaybackData.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficAnimationSyncData); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficAnimationSyncData); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/MassTrafficInstancePlaybackHelpers.h" },
...
// ********** Begin ScriptStruct FMassTrafficAnimationSyncData constinit property declarations *****
// ********** End ScriptStruct FMassTrafficAnimationSyncData constinit property declarations *******
	static void* NewStructOps()
	{
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMassTrafficAnimationSyncData;
class UScriptStruct* FMassTrafficAnimationSyncData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficAnimationSyncData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMassTrafficAnimationSyncData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassTrafficAnimationSyncData, (UObject*)Z_Construct_UPackage__Script_MassTraffic(), TEXT("MassTrafficAnimationSyncData"));
	}
	return Z_Registration_Info_UScriptStruct_FMassTrafficAnimationSyncData.OuterSingleton;
	}
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficAnimationSyncData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficAnimationSyncData.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficAnimationSyncData_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficAnimationSyncData.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FMassTrafficInstanceData); }
	static inline consteval int16 GetStructAlignment() { return alignof(FMassTrafficInstanceData); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/MassTrafficInstancePlaybackHelpers.h" },
...
// ********** Begin ScriptStruct FMassTrafficInstanceData constinit property declarations **********
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FMassTrafficInstanceData constinit property declarations ************
	static void* NewStructOps()
	{
...
// ********** End ScriptStruct FMassTrafficInstanceData Property Definitions ***********************
...
{
	if (!Z_Registration_Info_UScriptStruct_FMassTrafficInstanceData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMassTrafficInstanceData.InnerSingleton, Z_Construct_UScriptStruct_FMassTrafficInstanceData_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FMassTrafficInstanceData.InnerSingleton);
}
...
// ********** Begin Function AnimStateFromDataAsset constinit property declarations ****************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function AnimStateFromDataAsset constinit property declarations ******************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function AnimStateFromDataAsset Property Definitions ***************************
...
// ********** End Function AnimStateFromDataAsset Property Definitions *****************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMassTrafficInstancePlaybackLibrary_AnimStateFromDataAsset_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UMassTrafficInstancePlaybackLibrary, nullptr, "AnimStateFromDataAsset", 	Z_Construct_UFunction_UMassTrafficInstancePlaybackLibrary_AnimStateFromDataAsset_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UMassTrafficInstancePlaybackLibrary_AnimStateFromDataAsset_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_UMassTrafficInstancePlaybackLibrary_AnimStateFromDataAsset_Statics::MassTrafficInstancePlaybackLibrary_eventAnimStateFromDataAsset_Parms),
...
FClassRegistrationInfo Z_Registration_Info_UClass_UMassTrafficInstancePlaybackLibrary;
UClass* UMassTrafficInstancePlaybackLibrary::GetPrivateStaticClass()
{
	using TClass = UMassTrafficInstancePlaybackLibrary;
	if (!Z_Registration_Info_UClass_UMassTrafficInstancePlaybackLibrary.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MassTrafficInstancePlaybackLibrary"),
			Z_Registration_Info_UClass_UMassTrafficInstancePlaybackLibrary.InnerSingleton,
			StaticRegisterNativesUMassTrafficInstancePlaybackLibrary,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMassTrafficInstancePlaybackLibrary.InnerSingleton;
}
UClass* Z_Construct_UClass_UMassTrafficInstancePlaybackLibrary_NoRegister()
{
	return UMassTrafficInstancePlaybackLibrary::GetPrivateStaticClass();
}
...
// ********** Begin Class UMassTrafficInstancePlaybackLibrary constinit property declarations ******
// ********** End Class UMassTrafficInstancePlaybackLibrary constinit property declarations ********
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("AnimStateFromDataAsset"), .Pointer = &UMassTrafficInstancePlaybackLibrary::execAnimStateFromDataAsset },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UMassTrafficInstancePlaybackLibrary_AnimStateFromDataAsset, "AnimStateFromDataAsset" }, // 2028683965
	};
...
void UMassTrafficInstancePlaybackLibrary::StaticRegisterNativesUMassTrafficInstancePlaybackLibrary()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_UMassTrafficInstancePlaybackLibrary_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMassTrafficInstancePlaybackLibrary);
UMassTrafficInstancePlaybackLibrary::~UMassTrafficInstancePlaybackLibrary() {}
// ********** End Class UMassTrafficInstancePlaybackLibrary ****************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInstancePlaybackHelpers_h__Script_MassTraffic_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMassTrafficAnimState::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficAnimState_Statics::NewStructOps, TEXT("MassTrafficAnimState"),&Z_Registration_Info_UScriptStruct_FMassTrafficAnimState, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficAnimState), 3767406818U) },
		{ FMassTrafficInstancePlaybackData::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficInstancePlaybackData_Statics::NewStructOps, TEXT("MassTrafficInstancePlaybackData"),&Z_Registration_Info_UScriptStruct_FMassTrafficInstancePlaybackData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficInstancePlaybackData), 1160170547U) },
		{ FMassTrafficAnimationSyncData::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficAnimationSyncData_Statics::NewStructOps, TEXT("MassTrafficAnimationSyncData"),&Z_Registration_Info_UScriptStruct_FMassTrafficAnimationSyncData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficAnimationSyncData), 3737289289U) },
		{ FMassTrafficInstanceData::StaticStruct, Z_Construct_UScriptStruct_FMassTrafficInstanceData_Statics::NewStructOps, TEXT("MassTrafficInstanceData"),&Z_Registration_Info_UScriptStruct_FMassTrafficInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTrafficInstanceData), 1046576535U) },
	};
...
}; // Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInstancePlaybackHelpers_h__Script_MassTraffic_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInstancePlaybackHelpers_h__Script_MassTraffic_83717751{
	TEXT("/Script/MassTraffic"),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInstancePlaybackHelpers_h__Script_MassTraffic_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInstancePlaybackHelpers_h__Script_MassTraffic_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInstancePlaybackHelpers_h__Script_MassTraffic_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MassTraffic_Test_main_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInstancePlaybackHelpers_h__Script_MassTraffic_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
